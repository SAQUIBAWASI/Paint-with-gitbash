          ...
          {[
            {
              ...
              desc: "Eco-friendly solutions that remove graffiti without harming surfaces.",
            },
            {
              title: "💦 High-Pressure Washing",
              desc: "Powerful washing techniques to clean stubborn graffiti.",
            },
            {
              title: "🛡 Protective Coatings",
              desc: "Prevention methods to keep your walls graffiti-free for longer.",
            },
            {
              title: "🏢 Commercial & Residential Cleaning",
              desc: "Tailored solutions for businesses and home exteriors.",
            },
          ].map((service, index) => (
            <div
              key={index}
            ...
            <div className="relative w-full max-w-lg p-6 bg-white rounded-lg shadow-xl sm:p-8">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                >
                  ...
                  <option value="Chemical-Free Removal">Chemical-Free Removal</option>
